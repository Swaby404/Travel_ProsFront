////psuedo code below for approach to do list!
//// create a javascript TO-DO list!
//should i declare something ? 

//1.create functon that saves information from the input and adds to list!
